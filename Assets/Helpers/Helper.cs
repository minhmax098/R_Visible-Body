...
public static class Helper
{
    ...
    // GetObjectOnTouchByTag: lấy đối tượng bằng cách chạm bằng thẻ
   ...
   {  
    ...
    //GetObjectInSpaceOnTouchByTag: lấy đối tượng trong không gian bằng cách chạm bằng thẻ 
    ...
    //IsTouchOnCurrentOrgan: kiểm tra xem có đang chạm vào cơ quan nào hiện tại hay không ?
